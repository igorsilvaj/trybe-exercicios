...
// o first-li possui a classe tech com um transform que move o elemento para cima.
...
function adicionaTech(elemento) {
    let item = document.querySelector('.tech');
...
input.addEventListener('keyup', function(elemento) {
    let item = document.querySelector('.tech');
    item.innerText = elemento.target.value;
});
